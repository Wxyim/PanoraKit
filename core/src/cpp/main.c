...
JNIEXPORT jstring JNICALL
Java_com_github_yumelira_yumebox_core_bridge_Bridge_nativeReadOverride(JNIEnv *env, jobject thiz,
                                                                  jint slot) {
    TRACE_METHOD();
...
JNIEXPORT void JNICALL
Java_com_github_yumelira_yumebox_core_bridge_Bridge_nativeWriteOverride(JNIEnv *env, jobject thiz,
                                                                   jint slot,
                                                                   jstring content) {
    TRACE_METHOD();
...
JNIEXPORT void JNICALL
Java_com_github_yumelira_yumebox_core_bridge_Bridge_nativeClearOverride(JNIEnv *env, jobject thiz,
                                                                   jint slot) {
    TRACE_METHOD();
