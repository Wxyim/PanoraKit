...
import com.github.nomadboxlab.monadbox.presentation.screen.ProvidersContent
...
fun ProvidersScreen(navigator: DestinationsNavigator) {
    ...
    ProvidersContent(
        navigator = navigator,
        viewModel = viewModel,
        onRefreshSourcesRequest = viewModel::refreshAllSources,
        refreshSourcesInProgress = uiState.isUpdatingAll,
    )
}
