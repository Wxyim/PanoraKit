...
import com.github.nomadboxlab.monadbox.feature.settings.NetworkSettingsScreenBody
...
fun NetworkSettingsScreen(navigator: DestinationsNavigator) {
    NetworkSettingsScreenBody(
        navigator = navigator,
        onNavigateToAccessControl = { navigator.navigate(AccessControlScreenDestination) },
    )
}
