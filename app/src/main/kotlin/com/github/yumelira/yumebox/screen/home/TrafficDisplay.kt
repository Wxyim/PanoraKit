...
fun TrafficDisplay(
    ...
    Column(
        ...
        UploadSection(uploadSpeed = trafficNow.upload, isRunning = isRunning, isTunMode = isTunMode)
    }
}
...
@Composable
private fun UploadSection(uploadSpeed: Long, isRunning: Boolean, isTunMode: Boolean) {
    ...
    Column(
        ...
        Row(
            ...
            AnimatedVisibility(
                ...
                ProxyTypeCapsule(isTunMode = isTunMode)
            }
        }
    }
}
...
@Composable
private fun ProxyTypeCapsule(isTunMode: Boolean) {
    ...
    Surface(
        ...
        Row(
            ...
            Icon(
                imageVector = if (isTunMode) Yume.PlaneTakeoff else Yume.`Wifi-cog`,
                contentDescription = null,
                tint = primary,
                modifier = Modifier.size(12.dp)
            )
            Text(
                text = if (isTunMode) "VPN" else "SYS",
                style = MiuixTheme.textStyles.footnote1.copy(
                    fontSize = 12.sp,
                    fontWeight = FontWeight.Bold
                ),
