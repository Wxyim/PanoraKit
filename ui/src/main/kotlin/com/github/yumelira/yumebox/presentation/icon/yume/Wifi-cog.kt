...
val Yume.`Wifi-cog`: ImageVector
    get() {
        if (`_wifi-cog` != null) {
            return `_wifi-cog`!!
        }
        `_wifi-cog` = Builder(name = "Wifi-cog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(2.0f, 7.82f)
                arcToRelative(15.0f, 15.0f, 0.0f, false, true, 20.0f, 0.0f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Round, strokeLineMiter = 4.0f, pathFillType = NonZero
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                moveTo(5.0f, 11.858f)
                arcToRelative(10.0f, 10.0f, 0.0f, false, true, 11.5f, -1.785f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Round, strokeLineMiter = 4.0f, pathFillType = NonZero
                ...
                moveTo(8.5f, 15.429f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, 2.413f, -1.31f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Round, strokeLineMiter = 4.0f, pathFillType = NonZero
...
private var `_wifi-cog`: ImageVector? = null
