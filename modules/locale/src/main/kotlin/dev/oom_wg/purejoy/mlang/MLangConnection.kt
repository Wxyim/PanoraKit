...
object MLangConnection {
    ...
    fun `Title`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.connection_title, *args)
    ...
    fun `Summary`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.connection_summary, *args)
    ...
    object `Tab` {
        ...
        fun `Active`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_tab_active, *args)
        ...
        fun `Closed`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_tab_closed, *args)
    }
    ...
    fun `Search`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.connection_search, *args)
    ...
    fun `SearchHint`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.connection_search_hint, *args)

    val `SortBy`: String
        get() = LocaleBootstrap.getString(R.string.connection_sort_by)

    @Composable
    fun `SortBy`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.connection_sort_by, *args)
    ...
    object `Sort` {
        ...
        @Composable
        fun `Time`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_sort_time, *args)
        ...
        fun `Upload`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_sort_upload, *args)
        ...
        fun `Download`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_sort_download, *args)

        val `Host`: String
            get() = LocaleBootstrap.getString(R.string.connection_sort_host)

        @Composable
        fun `Host`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_sort_host, *args)
    }
    ...
    fun `Loading`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.connection_loading, *args)
    ...
    fun `Empty`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.connection_empty, *args)
    ...
    fun `NoResults`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.connection_no_results, *args)
    ...
    object `RelativeTime` {
        ...
        fun `JustNow`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_relative_time_just_now, *args)
        ...
        fun `MinutesAgo`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_relative_time_minutes_ago, *args)
        ...
        fun `HoursAgo`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_relative_time_hours_ago, *args)
        ...
        fun `DaysAgo`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.connection_relative_time_days_ago, *args)
    }
