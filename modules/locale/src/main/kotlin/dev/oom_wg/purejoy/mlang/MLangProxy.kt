...
object MLangProxy {
    ...
    @Composable
    fun `Title`(vararg args: Any): String = LocaleBootstrap.getString(R.string.proxy_title, *args)
    ...
    object `Mode` {
        ...
        fun `Direct`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_mode_direct, *args)
        ...
        fun `Global`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_mode_global, *args)
        ...
        fun `Rule`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_mode_rule, *args)
        ...
        fun `Switched`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_mode_switched, *args)
        ...
        fun `SwitchFailed`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_mode_switch_failed, *args)
    }
    ...
    object `Action` {
        ...
        fun `Test`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_action_test, *args)
        ...
        fun `More`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_action_more, *args)
        ...
        fun `GroupStyle`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_action_group_style, *args)
        ...
        fun `ShowHiddenGroups`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_action_show_hidden_groups, *args)
        ...
        fun `Back`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_action_back, *args)
        ...
        fun `Close`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_action_close, *args)
        ...
        fun `TestDelay`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_action_test_delay, *args)
        ...
        fun `SortMode`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_action_sort_mode, *args)
    ...
    object `Empty` {
        ...
        fun `NoNodes`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_empty_no_nodes, *args)
    ...
    object `Testing` {
        ...
        fun `Failed`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_testing_failed, *args)
        ...
        fun `InProgress`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_testing_in_progress, *args)
    }
    ...
    object `Selection` {
        ...
        @Composable
        fun `Failed`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_selection_failed, *args)
        ...
        fun `Error`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_selection_error, *args)
        ...
        fun `Current`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_selection_current, *args)
        ...
        fun `CurrentNode`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_selection_current_node, *args)
        ...
        fun `NodeCount`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_selection_node_count, *args)
        ...
        fun `Latency`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_selection_latency, *args)
        ...
        fun `Timeout`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_selection_timeout, *args)
        ...
        fun `UnknownLatency`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_selection_unknown_latency, *args)
    }
    ...
    object `SortMode` {
        ...
        fun `Default`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_sort_mode_default, *args)
        ...
        fun `ByName`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_sort_mode_by_name, *args)
        ...
        fun `ByLatency`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_sort_mode_by_latency, *args)
    }
    ...
    object `DisplayMode` {
        ...
        fun `SingleDetailed`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_display_mode_single_detailed, *args)
        ...
        fun `SingleSimple`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_display_mode_single_simple, *args)
        ...
        fun `DoubleDetailed`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_display_mode_double_detailed, *args)
        ...
        fun `DoubleSimple`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_display_mode_double_simple, *args)
    }
    ...
    object `GroupStyle` {
        ...
        fun `Inline`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_group_style_inline, *args)
        ...
        fun `Floating`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.proxy_group_style_floating, *args)
    }
}
