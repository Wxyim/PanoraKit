...
object MLangOverride {
    ...
    @Composable
    fun `Title`(vararg args: Any): String = stringResource(R.string.override_title, *args)
    ...
    object `Action` {
        ...
        fun `Create`(vararg args: Any): String =
            stringResource(R.string.override_action_create, *args)

        val `New`: String
            get() = LocaleBootstrap.getString(R.string.override_action_new)

        @Composable
        fun `New`(vararg args: Any): String = stringResource(R.string.override_action_new, *args)
        ...
        fun `Import`(vararg args: Any): String =
            stringResource(R.string.override_action_import, *args)
        ...
        fun `ImportFile`(vararg args: Any): String =
            stringResource(R.string.override_action_import_file, *args)
        ...
        fun `ImportFromUrl`(vararg args: Any): String =
            stringResource(R.string.override_action_import_from_url, *args)
        ...
        fun `ImportSurge`(vararg args: Any): String =
            stringResource(R.string.override_action_import_surge, *args)
        ...
        fun `ImportJsonUrl`(vararg args: Any): String =
            stringResource(R.string.override_action_import_json_url, *args)
        ...
        fun `ImportSurgeUrl`(vararg args: Any): String =
            stringResource(R.string.override_action_import_surge_url, *args)
    }
    ...
    object `Empty` {
        ...
        @Composable
        fun `Title`(vararg args: Any): String = stringResource(R.string.override_empty_title, *args)

        val `Hint`: String
            get() = LocaleBootstrap.getString(R.string.override_empty_hint)

        @Composable
        fun `Hint`(vararg args: Any): String = stringResource(R.string.override_empty_hint, *args)
    }
    ...
    object `Status` {
        ...
        fun `InUse`(vararg args: Any): String =
            stringResource(R.string.override_status_in_use, *args)
        ...
        fun `NotInUse`(vararg args: Any): String =
            stringResource(R.string.override_status_not_in_use, *args)
    }
    ...
    object `Card` {
        ...
        @Composable
        fun `Copy`(vararg args: Any): String = stringResource(R.string.override_card_copy, *args)
        ...
        fun `Export`(vararg args: Any): String =
            stringResource(R.string.override_card_export, *args)

        val `Edit`: String
            get() = LocaleBootstrap.getString(R.string.override_card_edit)

        @Composable
        fun `Edit`(vararg args: Any): String = stringResource(R.string.override_card_edit, *args)
        ...
        fun `Delete`(vararg args: Any): String =
            stringResource(R.string.override_card_delete, *args)
        ...
        fun `EditButton`(vararg args: Any): String =
            stringResource(R.string.override_card_edit_button, *args)
        ...
        fun `DeleteButton`(vararg args: Any): String =
            stringResource(R.string.override_card_delete_button, *args)
        ...
        fun `NoDescription`(vararg args: Any): String =
            stringResource(R.string.override_card_no_description, *args)
    }
    ...
    object `Import` {
        ...
        fun `ReadError`(vararg args: Any): String =
            stringResource(R.string.override_import_read_error, *args)
        ...
        fun `Success`(vararg args: Any): String =
            stringResource(R.string.override_import_success, *args)
        ...
        fun `SuccessDefault`(vararg args: Any): String =
            stringResource(R.string.override_import_success_default, *args)
        ...
        fun `Failed`(vararg args: Any): String =
            stringResource(R.string.override_import_failed, *args)
        ...
        fun `FileError`(vararg args: Any): String =
            stringResource(R.string.override_import_file_error, *args)
        ...
        fun `SurgeSuccess`(vararg args: Any): String =
            stringResource(R.string.override_import_surge_success, *args)
        ...
        fun `SurgeSuccessDefault`(vararg args: Any): String =
            stringResource(R.string.override_import_surge_success_default, *args)
        ...
        fun `SurgeNoRules`(vararg args: Any): String =
            stringResource(R.string.override_import_surge_no_rules, *args)
        ...
        fun `SurgeImportDescription`(vararg args: Any): String =
            stringResource(R.string.override_import_surge_import_description, *args)
        ...
        fun `PluginNoRules`(vararg args: Any): String =
            stringResource(R.string.override_import_plugin_no_rules, *args)
        ...
        fun `PluginImportDescription`(vararg args: Any): String =
            stringResource(R.string.override_import_plugin_import_description, *args)
        ...
        fun `AutoDetectFailed`(vararg args: Any): String =
            stringResource(R.string.override_import_auto_detect_failed, *args)
        ...
        fun `UrlLabel`(vararg args: Any): String =
            stringResource(R.string.override_import_url_label, *args)
        ...
        fun `UrlDownloading`(vararg args: Any): String =
            stringResource(R.string.override_import_url_downloading, *args)
        ...
        fun `UrlInvalidScheme`(vararg args: Any): String =
            stringResource(R.string.override_import_url_invalid_scheme, *args)
        ...
        fun `UrlHttpsRequired`(vararg args: Any): String =
            stringResource(R.string.override_import_url_https_required, *args)
        ...
        fun `UrlHttpError`(vararg args: Any): String =
            stringResource(R.string.override_import_url_http_error, *args)
        ...
        fun `UrlContentTooLarge`(vararg args: Any): String =
            stringResource(R.string.override_import_url_content_too_large, *args)
        ...
        fun `UrlRedirectInvalid`(vararg args: Any): String =
            stringResource(R.string.override_import_url_redirect_invalid, *args)
        ...
        fun `UrlTooManyRedirects`(vararg args: Any): String =
            stringResource(R.string.override_import_url_too_many_redirects, *args)
        ...
        object `UrlSheet` {
            ...
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_import_url_sheet_title, *args)
            ...
            fun `JsonTitle`(vararg args: Any): String =
                stringResource(R.string.override_import_url_sheet_json_title, *args)
            ...
            fun `SurgeTitle`(vararg args: Any): String =
                stringResource(R.string.override_import_url_sheet_surge_title, *args)
        }
    }
    ...
    object `Export` {
        ...
        @Composable
        fun `Failed`(vararg args: Any): String =
            stringResource(R.string.override_export_failed, *args)
        ...
        @Composable
        fun `Success`(vararg args: Any): String =
            stringResource(R.string.override_export_success, *args)
    }
    ...
    object `Dialog` {
        object `Create` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_dialog_create_title, *args)
            ...
            fun `Name`(vararg args: Any): String =
                stringResource(R.string.override_dialog_create_name, *args)
            ...
            fun `Description`(vararg args: Any): String =
                stringResource(R.string.override_dialog_create_description, *args)
            ...
            fun `ImportHint`(vararg args: Any): String =
                stringResource(R.string.override_dialog_create_import_hint, *args)
            ...
            fun `ImportFromUrlHint`(vararg args: Any): String =
                stringResource(R.string.override_dialog_create_import_from_url_hint, *args)
            ...
            fun `ImportSurgeHint`(vararg args: Any): String =
                stringResource(R.string.override_dialog_create_import_surge_hint, *args)
            ...
            fun `ImportJsonUrlHint`(vararg args: Any): String =
                stringResource(R.string.override_dialog_create_import_json_url_hint, *args)
            ...
            fun `ImportSurgeUrlHint`(vararg args: Any): String =
                stringResource(R.string.override_dialog_create_import_surge_url_hint, *args)
        }
        ...
        object `Delete` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_dialog_delete_title, *args)
            ...
            fun `InUseMessage`(vararg args: Any): String =
                stringResource(R.string.override_dialog_delete_in_use_message, *args)
            ...
            fun `Message`(vararg args: Any): String =
                stringResource(R.string.override_dialog_delete_message, *args)
        }
        ...
        object `EditOptions` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_dialog_edit_options_title, *args)
            ...
            fun `CodeEditor`(vararg args: Any): String =
                stringResource(R.string.override_dialog_edit_options_code_editor, *args)
            ...
            fun `VisualEditor`(vararg args: Any): String =
                stringResource(R.string.override_dialog_edit_options_visual_editor, *args)
        }
        ...
        object `Button` {
            ...
            fun `Cancel`(vararg args: Any): String =
                stringResource(R.string.override_dialog_button_cancel, *args)
            ...
            @Composable
            fun `Delete`(vararg args: Any): String =
                stringResource(R.string.override_dialog_button_delete, *args)
        }
    }
    ...
    object `Edit` {
        ...
        fun `TitleNew`(vararg args: Any): String =
            stringResource(R.string.override_edit_title_new, *args)
        ...
        fun `JsonEditHint`(vararg args: Any): String =
            stringResource(R.string.override_edit_json_edit_hint, *args)
        ...
        fun `StructuredObjectListHint`(vararg args: Any): String =
            stringResource(R.string.override_edit_structured_object_list_hint, *args)
        ...
        fun `StructuredProviderDictHint`(vararg args: Any): String =
            stringResource(R.string.override_edit_structured_provider_dict_hint, *args)
        ...
        fun `SubRuleGroupHint`(vararg args: Any): String =
            stringResource(R.string.override_edit_sub_rule_group_hint, *args)
        ...
        fun `JsonKeyValueHint`(vararg args: Any): String =
            stringResource(R.string.override_edit_json_key_value_hint, *args)
        ...
        fun `OneProviderPerLineHint`(vararg args: Any): String =
            stringResource(R.string.override_edit_one_provider_per_line_hint, *args)
        ...
        fun `TitleEdit`(vararg args: Any): String =
            stringResource(R.string.override_edit_title_edit, *args)
        ...
        object `EmptyName` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_edit_empty_name_title, *args)
            ...
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_edit_empty_name_summary, *args)
        }
        ...
        object `Button` {
            ...
            @Composable
            fun `Cancel`(vararg args: Any): String =
                stringResource(R.string.override_edit_button_cancel, *args)
            ...
            fun `Discard`(vararg args: Any): String =
                stringResource(R.string.override_edit_button_discard, *args)
        }
        ...
        fun `PresetApplied`(vararg args: Any): String =
            stringResource(R.string.override_edit_preset_applied, *args)
    }
    ...
    object `Section` {
        object `General` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_general_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_general_summary, *args)
        }
        ...
        object `Dns` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_dns_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_dns_summary, *args)
        }
        ...
        object `Sniffer` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_sniffer_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_sniffer_summary, *args)
        }
        ...
        object `Inbound` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_inbound_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_inbound_summary, *args)
        }
        ...
        object `Tun` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_tun_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_tun_summary, *args)
        }
        ...
        object `Rules` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_rules_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_rules_summary, *args)
        }
        ...
        object `Proxies` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_proxies_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_proxies_summary, *args)
        }
        ...
        object `ProxyProviders` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_proxy_providers_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_proxy_providers_summary, *args)
        }
        ...
        object `ProxyGroups` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_proxy_groups_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_proxy_groups_summary, *args)
        }
        ...
        object `RuleProviders` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_rule_providers_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_rule_providers_summary, *args)
        }
        ...
        object `SubRules` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_section_sub_rules_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_section_sub_rules_summary, *args)
        }
    }
    ...
    object `Modifier` {
        ...
        fun `Replace`(vararg args: Any): String =
            stringResource(R.string.override_modifier_replace, *args)
        ...
        fun `Start`(vararg args: Any): String =
            stringResource(R.string.override_modifier_start, *args)

        val `End`: String
            get() = LocaleBootstrap.getString(R.string.override_modifier_end)

        @Composable
        fun `End`(vararg args: Any): String = stringResource(R.string.override_modifier_end, *args)
        ...
        fun `Merge`(vararg args: Any): String =
            stringResource(R.string.override_modifier_merge, *args)
        ...
        fun `Force`(vararg args: Any): String =
            stringResource(R.string.override_modifier_force, *args)
        ...
        fun `NotModified`(vararg args: Any): String =
            stringResource(R.string.override_modifier_not_modified, *args)
        ...
        fun `ItemsCount`(vararg args: Any): String =
            stringResource(R.string.override_modifier_items_count, *args)
        ...
        fun `NoChanges`(vararg args: Any): String =
            stringResource(R.string.override_modifier_no_changes, *args)
    }
    ...
    object `Structured` {
        object `Proxies` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_structured_proxies_title, *args)
            ...
            fun `ItemLabel`(vararg args: Any): String =
                stringResource(R.string.override_structured_proxies_item_label, *args)
            ...
            fun `EmptyHint`(vararg args: Any): String =
                stringResource(R.string.override_structured_proxies_empty_hint, *args)
        }
        ...
        object `ProxyGroups` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_structured_proxy_groups_title, *args)
            ...
            @Composable
            fun `ItemLabel`(vararg args: Any): String =
                stringResource(R.string.override_structured_proxy_groups_item_label, *args)
            ...
            @Composable
            fun `EmptyHint`(vararg args: Any): String =
                stringResource(R.string.override_structured_proxy_groups_empty_hint, *args)
        }
        ...
        object `RuleProviders` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_structured_rule_providers_title, *args)
            ...
            @Composable
            fun `ItemLabel`(vararg args: Any): String =
                stringResource(R.string.override_structured_rule_providers_item_label, *args)
        }
        ...
        object `ProxyProviders` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_structured_proxy_providers_title, *args)
            ...
            @Composable
            fun `ItemLabel`(vararg args: Any): String =
                stringResource(R.string.override_structured_proxy_providers_item_label, *args)
        }
        ...
        object `SubRules` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_structured_sub_rules_title, *args)
            ...
            @Composable
            fun `ItemLabel`(vararg args: Any): String =
                stringResource(R.string.override_structured_sub_rules_item_label, *args)
        }
    }
    ...
    object `Editor` {
        object `Mode` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_editor_mode_title, *args)
            ...
            fun `EditTitle`(vararg args: Any): String =
                stringResource(R.string.override_editor_mode_edit_title, *args)
            ...
            fun `DirectEdit`(vararg args: Any): String =
                stringResource(R.string.override_editor_mode_direct_edit, *args)
        }
        ...
        object `ClearDialog` {
            ...
            @Composable
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.override_editor_clear_dialog_title, *args)
            ...
            @Composable
            fun `Summary`(vararg args: Any): String =
                stringResource(R.string.override_editor_clear_dialog_summary, *args)
        }
        ...
        @Composable
        fun `New`(vararg args: Any): String = stringResource(R.string.override_editor_new, *args)
        ...
        fun `AddNamedItem`(vararg args: Any): String =
            stringResource(R.string.override_editor_add_named_item, *args)
        ...
        fun `NewRule`(vararg args: Any): String =
            stringResource(R.string.override_editor_new_rule, *args)
        ...
        fun `EditRule`(vararg args: Any): String =
            stringResource(R.string.override_editor_edit_rule, *args)
        ...
        fun `NewSubRuleGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_new_sub_rule_group, *args)
        ...
        fun `UnnamedSubRuleGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_unnamed_sub_rule_group, *args)
        ...
        fun `EditSubRuleGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_edit_sub_rule_group, *args)
        ...
        fun `ClearSubRules`(vararg args: Any): String =
            stringResource(R.string.override_editor_clear_sub_rules, *args)
        ...
        fun `Unnamed`(vararg args: Any): String =
            stringResource(R.string.override_editor_unnamed, *args)
        ...
        fun `UnnamedRule`(vararg args: Any): String =
            stringResource(R.string.override_editor_unnamed_rule, *args)

        val `Edit`: String
            get() = LocaleBootstrap.getString(R.string.override_editor_edit)

        @Composable
        fun `Edit`(vararg args: Any): String = stringResource(R.string.override_editor_edit, *args)
        ...
        fun `DragToSort`(vararg args: Any): String =
            stringResource(R.string.override_editor_drag_to_sort, *args)
        ...
        fun `CancelDelete`(vararg args: Any): String =
            stringResource(R.string.override_editor_cancel_delete, *args)
        ...
        fun `DeleteSelected`(vararg args: Any): String =
            stringResource(R.string.override_editor_delete_selected, *args)
        ...
        fun `DeleteSelectedNamedItem`(vararg args: Any): String =
            stringResource(R.string.override_editor_delete_selected_named_item, *args)
        ...
        fun `DeleteSelectedRules`(vararg args: Any): String =
            stringResource(R.string.override_editor_delete_selected_rules, *args)
        ...
        fun `ClearMode`(vararg args: Any): String =
            stringResource(R.string.override_editor_clear_mode, *args)
        ...
        fun `EnterDeleteMode`(vararg args: Any): String =
            stringResource(R.string.override_editor_enter_delete_mode, *args)
        ...
        fun `EmptyString`(vararg args: Any): String =
            stringResource(R.string.override_editor_empty_string, *args)
        ...
        fun `ArrayItems`(vararg args: Any): String =
            stringResource(R.string.override_editor_array_items, *args)
        ...
        fun `ObjectFields`(vararg args: Any): String =
            stringResource(R.string.override_editor_object_fields, *args)
        ...
        fun `Clear`(vararg args: Any): String =
            stringResource(R.string.override_editor_clear, *args)
        ...
        fun `Rules`(vararg args: Any): String =
            stringResource(R.string.override_editor_rules, *args)
        ...
        fun `AddCustom`(vararg args: Any): String =
            stringResource(R.string.override_editor_add_custom, *args)
        ...
        fun `ContentEmpty`(vararg args: Any): String =
            stringResource(R.string.override_editor_content_empty, *args)
        ...
        fun `Confirm`(vararg args: Any): String =
            stringResource(R.string.override_editor_confirm, *args)
        ...
        fun `OneItemPerLine`(vararg args: Any): String =
            stringResource(R.string.override_editor_one_item_per_line, *args)
        ...
        fun `AddItem`(vararg args: Any): String =
            stringResource(R.string.override_editor_add_item, *args)
        ...
        fun `DeleteLastItem`(vararg args: Any): String =
            stringResource(R.string.override_editor_delete_last_item, *args)

        val `Copy`: String
            get() = LocaleBootstrap.getString(R.string.override_editor_copy)

        @Composable
        fun `Copy`(vararg args: Any): String = stringResource(R.string.override_editor_copy, *args)
        ...
        @Composable
        fun `Delete`(vararg args: Any): String =
            stringResource(R.string.override_editor_delete, *args)
        ...
        fun `MoveUp`(vararg args: Any): String =
            stringResource(R.string.override_editor_move_up, *args)
        ...
        fun `MoveDown`(vararg args: Any): String =
            stringResource(R.string.override_editor_move_down, *args)
        ...
        fun `AddObject`(vararg args: Any): String =
            stringResource(R.string.override_editor_add_object, *args)
        ...
        fun `SubRuleName`(vararg args: Any): String =
            stringResource(R.string.override_editor_sub_rule_name, *args)
        ...
        fun `NoRules`(vararg args: Any): String =
            stringResource(R.string.override_editor_no_rules, *args)
        ...
        fun `RulesConfiguredInline`(vararg args: Any): String =
            stringResource(R.string.override_editor_rules_configured_inline, *args)
        ...
        fun `AddSubRuleGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_add_sub_rule_group, *args)
        ...
        fun `EditSubRule`(vararg args: Any): String =
            stringResource(R.string.override_editor_edit_sub_rule, *args)
        ...
        fun `KeyName`(vararg args: Any): String =
            stringResource(R.string.override_editor_key_name, *args)

        val `List`: String
            get() = LocaleBootstrap.getString(R.string.override_editor_list)

        @Composable
        fun `List`(vararg args: Any): String = stringResource(R.string.override_editor_list, *args)
        ...
        fun `EditItem`(vararg args: Any): String =
            stringResource(R.string.override_editor_edit_item, *args)
        ...
        fun `ClearCurrentMode`(vararg args: Any): String =
            stringResource(R.string.override_editor_clear_current_mode, *args)
        ...
        fun `NewProxyNode`(vararg args: Any): String =
            stringResource(R.string.override_editor_new_proxy_node, *args)
        ...
        fun `NewProxyGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_new_proxy_group, *args)
        ...
        fun `EditProxyNode`(vararg args: Any): String =
            stringResource(R.string.override_editor_edit_proxy_node, *args)
        ...
        fun `EditProxyGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_edit_proxy_group, *args)
        ...
        fun `UnnamedProxyNode`(vararg args: Any): String =
            stringResource(R.string.override_editor_unnamed_proxy_node, *args)
        ...
        fun `UnnamedProxyGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_unnamed_proxy_group, *args)
        ...
        fun `ProxyNode`(vararg args: Any): String =
            stringResource(R.string.override_editor_proxy_node, *args)
        ...
        fun `ProxyGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_proxy_group, *args)
        ...
        fun `RuleEdit`(vararg args: Any): String =
            stringResource(R.string.override_editor_rule_edit, *args)
        ...
        fun `SubRuleTarget`(vararg args: Any): String =
            stringResource(R.string.override_editor_sub_rule_target, *args)
        ...
        fun `ProxyGroupTarget`(vararg args: Any): String =
            stringResource(R.string.override_editor_proxy_group_target, *args)
        ...
        fun `RuleTypeEmpty`(vararg args: Any): String =
            stringResource(R.string.override_editor_rule_type_empty, *args)
        ...
        fun `PayloadEmpty`(vararg args: Any): String =
            stringResource(R.string.override_editor_payload_empty, *args)
        ...
        fun `TargetEmpty`(vararg args: Any): String =
            stringResource(R.string.override_editor_target_empty, *args)
        ...
        fun `MatchResult`(vararg args: Any): String =
            stringResource(R.string.override_editor_match_result, *args)
        ...
        fun `SelectMatchResult`(vararg args: Any): String =
            stringResource(R.string.override_editor_select_match_result, *args)
        ...
        fun `CustomMatchResult`(vararg args: Any): String =
            stringResource(R.string.override_editor_custom_match_result, *args)
        ...
        fun `SelectSubRuleTarget`(vararg args: Any): String =
            stringResource(R.string.override_editor_select_sub_rule_target, *args)
        ...
        fun `SelectProxyGroupTarget`(vararg args: Any): String =
            stringResource(R.string.override_editor_select_proxy_group_target, *args)
        ...
        fun `CustomSubRuleTarget`(vararg args: Any): String =
            stringResource(R.string.override_editor_custom_sub_rule_target, *args)
        ...
        fun `CustomProxyGroupTarget`(vararg args: Any): String =
            stringResource(R.string.override_editor_custom_proxy_group_target, *args)
        ...
        fun `SelectRuleProvider`(vararg args: Any): String =
            stringResource(R.string.override_editor_select_rule_provider, *args)
        ...
        fun `RuleBody`(vararg args: Any): String =
            stringResource(R.string.override_editor_rule_body, *args)
        ...
        fun `RuleType`(vararg args: Any): String =
            stringResource(R.string.override_editor_rule_type, *args)
        ...
        fun `Payload`(vararg args: Any): String =
            stringResource(R.string.override_editor_payload, *args)
        ...
        fun `AdditionalParams`(vararg args: Any): String =
            stringResource(R.string.override_editor_additional_params, *args)
        ...
        fun `BasicConnection`(vararg args: Any): String =
            stringResource(R.string.override_editor_basic_connection, *args)
        ...
        fun `NetworkAndRoute`(vararg args: Any): String =
            stringResource(R.string.override_editor_network_and_route, *args)
        ...
        fun `PortEmptyHint`(vararg args: Any): String =
            stringResource(R.string.override_editor_port_empty_hint, *args)
        ...
        fun `TypeEmpty`(vararg args: Any): String =
            stringResource(R.string.override_editor_type_empty, *args)
        ...
        fun `MemberSource`(vararg args: Any): String =
            stringResource(R.string.override_editor_member_source, *args)
        ...
        fun `HealthCheckAndFilter`(vararg args: Any): String =
            stringResource(R.string.override_editor_health_check_and_filter, *args)
        ...
        fun `SelectProxyGroupMember`(vararg args: Any): String =
            stringResource(R.string.override_editor_select_proxy_group_member, *args)
        ...
        fun `CustomMember`(vararg args: Any): String =
            stringResource(R.string.override_editor_custom_member, *args)
        ...
        fun `SaveProxyNode`(vararg args: Any): String =
            stringResource(R.string.override_editor_save_proxy_node, *args)
        ...
        fun `SaveProxyGroup`(vararg args: Any): String =
            stringResource(R.string.override_editor_save_proxy_group, *args)
        ...
        fun `SaveRule`(vararg args: Any): String =
            stringResource(R.string.override_editor_save_rule, *args)
        ...
        fun `RuleProviderInputHint`(vararg args: Any): String =
            stringResource(R.string.override_editor_rule_provider_input_hint, *args)
        ...
        fun `LogicalRuleHint`(vararg args: Any): String =
            stringResource(R.string.override_editor_logical_rule_hint, *args)
        ...
        fun `OtherExtraParams`(vararg args: Any): String =
            stringResource(R.string.override_editor_other_extra_params, *args)
        ...
        fun `ExtraParamsHint`(vararg args: Any): String =
            stringResource(R.string.override_editor_extra_params_hint, *args)
    }
    ...
    object `Draft` {
        ...
        fun `Object`(vararg args: Any): String =
            stringResource(R.string.override_draft_object, *args)
        ...
        fun `SubRuleGroup`(vararg args: Any): String =
            stringResource(R.string.override_draft_sub_rule_group, *args)

        val `Name`: String
            get() = LocaleBootstrap.getString(R.string.override_draft_name)

        @Composable
        fun `Name`(vararg args: Any): String = stringResource(R.string.override_draft_name, *args)
        ...
        fun `NameRequired`(vararg args: Any): String =
            stringResource(R.string.override_draft_name_required, *args)

        val `Save`: String
            get() = LocaleBootstrap.getString(R.string.override_draft_save)

        @Composable
        fun `Save`(vararg args: Any): String = stringResource(R.string.override_draft_save, *args)
        ...
        fun `BasicInfo`(vararg args: Any): String =
            stringResource(R.string.override_draft_basic_info, *args)
        ...
        fun `BasicIdentity`(vararg args: Any): String =
            stringResource(R.string.override_draft_basic_identity, *args)
        ...
        fun `CoreSource`(vararg args: Any): String =
            stringResource(R.string.override_draft_core_source, *args)
        ...
        fun `NetworkAuth`(vararg args: Any): String =
            stringResource(R.string.override_draft_network_auth, *args)

        val `Type`: String
            get() = LocaleBootstrap.getString(R.string.override_draft_type)

        @Composable
        fun `Type`(vararg args: Any): String = stringResource(R.string.override_draft_type, *args)
        ...
        fun `Vehicle`(vararg args: Any): String =
            stringResource(R.string.override_draft_vehicle, *args)
        ...
        fun `Behavior`(vararg args: Any): String =
            stringResource(R.string.override_draft_behavior, *args)
        ...
        fun `Format`(vararg args: Any): String =
            stringResource(R.string.override_draft_format, *args)
        ...
        fun `HealthCheck`(vararg args: Any): String =
            stringResource(R.string.override_draft_health_check, *args)
        ...
        fun `Override`(vararg args: Any): String =
            stringResource(R.string.override_draft_override, *args)
        ...
        fun `RuleList`(vararg args: Any): String =
            stringResource(R.string.override_draft_rule_list, *args)
        ...
        @Composable
        fun `NoRules`(vararg args: Any): String =
            stringResource(R.string.override_draft_no_rules, *args)
        ...
        fun `RulesConfigured`(vararg args: Any): String =
            stringResource(R.string.override_draft_rules_configured, *args)
        ...
        fun `EditSubRules`(vararg args: Any): String =
            stringResource(R.string.override_draft_edit_sub_rules, *args)
        ...
        fun `ExtraFields`(vararg args: Any): String =
            stringResource(R.string.override_draft_extra_fields, *args)
        ...
        fun `AddExtraField`(vararg args: Any): String =
            stringResource(R.string.override_draft_add_extra_field, *args)
        ...
        fun `EditExtraField`(vararg args: Any): String =
            stringResource(R.string.override_draft_edit_extra_field, *args)
        ...
        fun `AddHealthCheckField`(vararg args: Any): String =
            stringResource(R.string.override_draft_add_health_check_field, *args)
        ...
        fun `EditHealthCheckField`(vararg args: Any): String =
            stringResource(R.string.override_draft_edit_health_check_field, *args)
        ...
        fun `AddOverrideField`(vararg args: Any): String =
            stringResource(R.string.override_draft_add_override_field, *args)
        ...
        fun `EditOverrideField`(vararg args: Any): String =
            stringResource(R.string.override_draft_edit_override_field, *args)
        ...
        fun `HealthCheckSwitch`(vararg args: Any): String =
            stringResource(R.string.override_draft_health_check_switch, *args)
        ...
        fun `HealthCheckFields`(vararg args: Any): String =
            stringResource(R.string.override_draft_health_check_fields, *args)
        ...
        fun `OverrideSwitch`(vararg args: Any): String =
            stringResource(R.string.override_draft_override_switch, *args)
        ...
        fun `OverrideFields`(vararg args: Any): String =
            stringResource(R.string.override_draft_override_fields, *args)
        ...
        fun `BooleanOptions`(vararg args: Any): String =
            stringResource(R.string.override_draft_boolean_options, *args)
        ...
        fun `HeaderHint`(vararg args: Any): String =
            stringResource(R.string.override_draft_header_hint, *args)
        ...
        fun `ConfigName`(vararg args: Any): String =
            stringResource(R.string.override_draft_config_name, *args)
        ...
        fun `ConfigDescription`(vararg args: Any): String =
            stringResource(R.string.override_draft_config_description, *args)
        ...
        fun `PresetTemplate`(vararg args: Any): String =
            stringResource(R.string.override_draft_preset_template, *args)
        ...
        fun `OfficialMrs`(vararg args: Any): String =
            stringResource(R.string.override_draft_official_mrs, *args)
        ...
        fun `OfficialMrsSummary`(vararg args: Any): String =
            stringResource(R.string.override_draft_official_mrs_summary, *args)
        ...
        fun `ConfigSections`(vararg args: Any): String =
            stringResource(R.string.override_draft_config_sections, *args)

        val `Apply`: String
            get() = LocaleBootstrap.getString(R.string.override_draft_apply)

        @Composable
        fun `Apply`(vararg args: Any): String = stringResource(R.string.override_draft_apply, *args)
        ...
        fun `RegionalAutoGroup`(vararg args: Any): String =
            stringResource(R.string.override_draft_regional_auto_group, *args)
        ...
        fun `BasicRouting`(vararg args: Any): String =
            stringResource(R.string.override_draft_basic_routing, *args)
        ...
        fun `ServiceRouting`(vararg args: Any): String =
            stringResource(R.string.override_draft_service_routing, *args)
        ...
        fun `RegionHongKong`(vararg args: Any): String =
            stringResource(R.string.override_draft_region_hong_kong, *args)
        ...
        fun `RegionTaiwan`(vararg args: Any): String =
            stringResource(R.string.override_draft_region_taiwan, *args)
        ...
        fun `RegionJapan`(vararg args: Any): String =
            stringResource(R.string.override_draft_region_japan, *args)
        ...
        fun `RegionSingapore`(vararg args: Any): String =
            stringResource(R.string.override_draft_region_singapore, *args)
        ...
        fun `RegionUnitedStates`(vararg args: Any): String =
            stringResource(R.string.override_draft_region_united_states, *args)
        ...
        fun `ItemAds`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_ads, *args)
        ...
        fun `ItemPrivate`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_private, *args)
        ...
        fun `ItemGoogle`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_google, *args)
        ...
        fun `ItemTelegram`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_telegram, *args)
        ...
        fun `ItemGitHub`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_git_hub, *args)
        ...
        fun `ItemMicrosoft`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_microsoft, *args)
        ...
        fun `ItemApple`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_apple, *args)
        ...
        fun `ItemYouTube`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_you_tube, *args)
        ...
        fun `ItemNetflix`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_netflix, *args)
        ...
        fun `ItemSpotify`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_spotify, *args)
        ...
        fun `ItemOpenAI`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_open_a_i, *args)
        ...
        fun `ItemSteam`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_steam, *args)
        ...
        fun `ItemCn`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_cn, *args)
        ...
        fun `ItemProxy`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_proxy, *args)
        ...
        fun `ItemGeolocationNotCn`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_geolocation_not_cn, *args)
        ...
        fun `ItemMatch`(vararg args: Any): String =
            stringResource(R.string.override_draft_item_match, *args)
        ...
        fun `RemoteSourceUrl`(vararg args: Any): String =
            stringResource(R.string.override_draft_remote_source_url, *args)
        ...
        fun `RemoteUpdateInterval`(vararg args: Any): String =
            stringResource(R.string.override_draft_remote_update_interval, *args)
        ...
        fun `RemoteUpdateIntervalPlaceholder`(vararg args: Any): String =
            stringResource(R.string.override_draft_remote_update_interval_placeholder, *args)
        ...
        fun `ClickToAddExtraField`(vararg args: Any): String =
            stringResource(R.string.override_draft_click_to_add_extra_field, *args)
        ...
        fun `DeleteExtraField`(vararg args: Any): String =
            stringResource(R.string.override_draft_delete_extra_field, *args)
        ...
        fun `ValueType`(vararg args: Any): String =
            stringResource(R.string.override_draft_value_type, *args)
        ...
        fun `StringValue`(vararg args: Any): String =
            stringResource(R.string.override_draft_string_value, *args)
        ...
        fun `IntValue`(vararg args: Any): String =
            stringResource(R.string.override_draft_int_value, *args)
        ...
        fun `DoubleValue`(vararg args: Any): String =
            stringResource(R.string.override_draft_double_value, *args)
        ...
        fun `JsonFragment`(vararg args: Any): String =
            stringResource(R.string.override_draft_json_fragment, *args)
        ...
        fun `KeyNameEmpty`(vararg args: Any): String =
            stringResource(R.string.override_draft_key_name_empty, *args)
        ...
        fun `ValueTypeMismatch`(vararg args: Any): String =
            stringResource(R.string.override_draft_value_type_mismatch, *args)
    }
    ...
    object `Form` {
        ...
        fun `RuleChain`(vararg args: Any): String =
            stringResource(R.string.override_form_rule_chain, *args)
        ...
        fun `RuleChainNotSet`(vararg args: Any): String =
            stringResource(R.string.override_form_rule_chain_not_set, *args)
        ...
        fun `SubRules`(vararg args: Any): String =
            stringResource(R.string.override_form_sub_rules, *args)
        ...
        fun `SubRulesHint`(vararg args: Any): String =
            stringResource(R.string.override_form_sub_rules_hint, *args)
        ...
        fun `SubRulesAdvanced`(vararg args: Any): String =
            stringResource(R.string.override_form_sub_rules_advanced, *args)
        ...
        fun `RuleProviders`(vararg args: Any): String =
            stringResource(R.string.override_form_rule_providers, *args)
        ...
        fun `RuleProvidersHint`(vararg args: Any): String =
            stringResource(R.string.override_form_rule_providers_hint, *args)
        ...
        fun `RuleProvidersAdvanced`(vararg args: Any): String =
            stringResource(R.string.override_form_rule_providers_advanced, *args)
        ...
        fun `ProxyNodes`(vararg args: Any): String =
            stringResource(R.string.override_form_proxy_nodes, *args)
        ...
        fun `ProxyNodesHint`(vararg args: Any): String =
            stringResource(R.string.override_form_proxy_nodes_hint, *args)
        ...
        fun `ProxyProviders`(vararg args: Any): String =
            stringResource(R.string.override_form_proxy_providers, *args)
        ...
        fun `ProxyProvidersHint`(vararg args: Any): String =
            stringResource(R.string.override_form_proxy_providers_hint, *args)
        ...
        fun `ProxyProvidersAdvanced`(vararg args: Any): String =
            stringResource(R.string.override_form_proxy_providers_advanced, *args)
        ...
        fun `ProxyGroups`(vararg args: Any): String =
            stringResource(R.string.override_form_proxy_groups, *args)
        ...
        fun `ProxyGroupsHint`(vararg args: Any): String =
            stringResource(R.string.override_form_proxy_groups_hint, *args)
        ...
        fun `StructuredEdit`(vararg args: Any): String =
            stringResource(R.string.override_form_structured_edit, *args)
        ...
        fun `AdvancedJson`(vararg args: Any): String =
            stringResource(R.string.override_form_advanced_json, *args)
        ...
        fun `OpenAdvancedEdit`(vararg args: Any): String =
            stringResource(R.string.override_form_open_advanced_edit, *args)
        ...
        fun `OpenAdvancedEditSummary`(vararg args: Any): String =
            stringResource(R.string.override_form_open_advanced_edit_summary, *args)
        ...
        fun `ItemsConfigured`(vararg args: Any): String =
            stringResource(R.string.override_form_items_configured, *args)
        ...
        fun `ProxyPorts`(vararg args: Any): String =
            stringResource(R.string.override_form_proxy_ports, *args)
        ...
        fun `RunAndLog`(vararg args: Any): String =
            stringResource(R.string.override_form_run_and_log, *args)
        ...
        fun `ProcessMode`(vararg args: Any): String =
            stringResource(R.string.override_form_process_mode, *args)
        ...
        fun `NotModify`(vararg args: Any): String =
            stringResource(R.string.override_form_not_modify, *args)
        ...
        fun `UnifiedDelay`(vararg args: Any): String =
            stringResource(R.string.override_form_unified_delay, *args)
        ...
        fun `TcpConcurrent`(vararg args: Any): String =
            stringResource(R.string.override_form_tcp_concurrent, *args)
        ...
        fun `GeodataMode`(vararg args: Any): String =
            stringResource(R.string.override_form_geodata_mode, *args)
        ...
        fun `RunAndLogExtra`(vararg args: Any): String =
            stringResource(R.string.override_form_run_and_log_extra, *args)
        ...
        fun `Seconds`(vararg args: Any): String =
            stringResource(R.string.override_form_seconds, *args)
        ...
        fun `ConnectionNetwork`(vararg args: Any): String =
            stringResource(R.string.override_form_connection_network, *args)
        ...
        fun `OutboundInterface`(vararg args: Any): String =
            stringResource(R.string.override_form_outbound_interface, *args)
        ...
        fun `RoutingMark`(vararg args: Any): String =
            stringResource(R.string.override_form_routing_mark, *args)
        ...
        fun `GeositeMatcher`(vararg args: Any): String =
            stringResource(R.string.override_form_geosite_matcher, *args)
        ...
        fun `GlobalClientFingerprint`(vararg args: Any): String =
            stringResource(R.string.override_form_global_client_fingerprint, *args)
        ...
        fun `LanAccess`(vararg args: Any): String =
            stringResource(R.string.override_form_lan_access, *args)
        ...
        fun `AllowedIPs`(vararg args: Any): String =
            stringResource(R.string.override_form_allowed_i_ps, *args)
        ...
        fun `DisallowedIPs`(vararg args: Any): String =
            stringResource(R.string.override_form_disallowed_i_ps, *args)
        ...
        fun `LanAddress`(vararg args: Any): String =
            stringResource(R.string.override_form_lan_address, *args)
        ...
        fun `BindAddress`(vararg args: Any): String =
            stringResource(R.string.override_form_bind_address, *args)
        ...
        fun `UserAuth`(vararg args: Any): String =
            stringResource(R.string.override_form_user_auth, *args)
        ...
        fun `SkipAuthIPs`(vararg args: Any): String =
            stringResource(R.string.override_form_skip_auth_i_ps, *args)
        ...
        fun `ExternalControl`(vararg args: Any): String =
            stringResource(R.string.override_form_external_control, *args)
        ...
        fun `ExternalController`(vararg args: Any): String =
            stringResource(R.string.override_form_external_controller, *args)
        ...
        fun `ExternalControllerHttps`(vararg args: Any): String =
            stringResource(R.string.override_form_external_controller_https, *args)
        ...
        fun `ExternalDoH`(vararg args: Any): String =
            stringResource(R.string.override_form_external_do_h, *args)
        ...
        fun `ApiSecret`(vararg args: Any): String =
            stringResource(R.string.override_form_api_secret, *args)
        ...
        fun `ControllerCors`(vararg args: Any): String =
            stringResource(R.string.override_form_controller_cors, *args)
        ...
        fun `CorsAllowOrigins`(vararg args: Any): String =
            stringResource(R.string.override_form_cors_allow_origins, *args)
        ...
        fun `AllowPrivateNetwork`(vararg args: Any): String =
            stringResource(R.string.override_form_allow_private_network, *args)
        ...
        fun `ConfigPersistence`(vararg args: Any): String =
            stringResource(R.string.override_form_config_persistence, *args)
        ...
        fun `SaveGroupSelection`(vararg args: Any): String =
            stringResource(R.string.override_form_save_group_selection, *args)
        ...
        fun `SaveFakeIpMapping`(vararg args: Any): String =
            stringResource(R.string.override_form_save_fake_ip_mapping, *args)
        ...
        fun `GeoResources`(vararg args: Any): String =
            stringResource(R.string.override_form_geo_resources, *args)
        ...
        fun `AutoUpdateGeo`(vararg args: Any): String =
            stringResource(R.string.override_form_auto_update_geo, *args)
        ...
        fun `GeoUpdateInterval`(vararg args: Any): String =
            stringResource(R.string.override_form_geo_update_interval, *args)

        val `Hours`: String
            get() = LocaleBootstrap.getString(R.string.override_form_hours)

        @Composable
        fun `Hours`(vararg args: Any): String = stringResource(R.string.override_form_hours, *args)
        ...
        fun `GeoipUrl`(vararg args: Any): String =
            stringResource(R.string.override_form_geoip_url, *args)
        ...
        fun `GeositeUrl`(vararg args: Any): String =
            stringResource(R.string.override_form_geosite_url, *args)
        ...
        fun `MmdbUrl`(vararg args: Any): String =
            stringResource(R.string.override_form_mmdb_url, *args)
        ...
        fun `TunBasicSwitch`(vararg args: Any): String =
            stringResource(R.string.override_form_tun_basic_switch, *args)

        val `Stack`: String
            get() = LocaleBootstrap.getString(R.string.override_form_stack)

        @Composable
        fun `Stack`(vararg args: Any): String = stringResource(R.string.override_form_stack, *args)
        ...
        fun `AutoRoute`(vararg args: Any): String =
            stringResource(R.string.override_form_auto_route, *args)
        ...
        fun `AutoRedirect`(vararg args: Any): String =
            stringResource(R.string.override_form_auto_redirect, *args)
        ...
        fun `AutoDetectInterface`(vararg args: Any): String =
            stringResource(R.string.override_form_auto_detect_interface, *args)
        ...
        fun `StrictRoute`(vararg args: Any): String =
            stringResource(R.string.override_form_strict_route, *args)
        ...
        fun `EndpointIndependentNat`(vararg args: Any): String =
            stringResource(R.string.override_form_endpoint_independent_nat, *args)
        ...
        fun `NetworkPerfSwitch`(vararg args: Any): String =
            stringResource(R.string.override_form_network_perf_switch, *args)
        ...
        fun `EnableGso`(vararg args: Any): String =
            stringResource(R.string.override_form_enable_gso, *args)
        ...
        fun `DisableIcmpForward`(vararg args: Any): String =
            stringResource(R.string.override_form_disable_icmp_forward, *args)
        ...
        fun `NetworkPerfParams`(vararg args: Any): String =
            stringResource(R.string.override_form_network_perf_params, *args)

        val `Mtu`: String
            get() = LocaleBootstrap.getString(R.string.override_form_mtu)

        @Composable
        fun `Mtu`(vararg args: Any): String = stringResource(R.string.override_form_mtu, *args)
        ...
        fun `GsoMaxSize`(vararg args: Any): String =
            stringResource(R.string.override_form_gso_max_size, *args)
        ...
        fun `DnsBasicSwitch`(vararg args: Any): String =
            stringResource(R.string.override_form_dns_basic_switch, *args)
        ...
        fun `DnsBasicParams`(vararg args: Any): String =
            stringResource(R.string.override_form_dns_basic_params, *args)
        ...
        fun `DnsFakeIpRange`(vararg args: Any): String =
            stringResource(R.string.override_form_dns_fake_ip_range, *args)
        ...
        fun `FakeIpMode`(vararg args: Any): String =
            stringResource(R.string.override_form_fake_ip_mode, *args)
        ...
        fun `FakeIpParams`(vararg args: Any): String =
            stringResource(R.string.override_form_fake_ip_params, *args)
        ...
        fun `DnsUpstream`(vararg args: Any): String =
            stringResource(R.string.override_form_dns_upstream, *args)
        ...
        fun `DnsPolicyMode`(vararg args: Any): String =
            stringResource(R.string.override_form_dns_policy_mode, *args)
        ...
        fun `SnifferSwitch`(vararg args: Any): String =
            stringResource(R.string.override_form_sniffer_switch, *args)
        ...
        fun `SnifferPorts`(vararg args: Any): String =
            stringResource(R.string.override_form_sniffer_ports, *args)
        ...
        fun `SnifferOverride`(vararg args: Any): String =
            stringResource(R.string.override_form_sniffer_override, *args)
        ...
        fun `SnifferSkipDomain`(vararg args: Any): String =
            stringResource(R.string.override_form_sniffer_skip_domain, *args)
        ...
        fun `SnifferForceDomain`(vararg args: Any): String =
            stringResource(R.string.override_form_sniffer_force_domain, *args)
        ...
        fun `SnifferParsePureIp`(vararg args: Any): String =
            stringResource(R.string.override_form_sniffer_parse_pure_ip, *args)
        ...
        fun `TunRouteAndApps`(vararg args: Any): String =
            stringResource(R.string.override_form_tun_route_and_apps, *args)
        ...
        fun `DnsHijack`(vararg args: Any): String =
            stringResource(R.string.override_form_dns_hijack, *args)
        ...
        fun `RouteAddress`(vararg args: Any): String =
            stringResource(R.string.override_form_route_address, *args)
        ...
        fun `RouteExcludeAddress`(vararg args: Any): String =
            stringResource(R.string.override_form_route_exclude_address, *args)
        ...
        fun `IncludePackage`(vararg args: Any): String =
            stringResource(R.string.override_form_include_package, *args)
        ...
        fun `ExcludePackage`(vararg args: Any): String =
            stringResource(R.string.override_form_exclude_package, *args)
        ...
        fun `CacheLimit`(vararg args: Any): String =
            stringResource(R.string.override_form_cache_limit, *args)
        ...
        fun `DnsUpstreamServers`(vararg args: Any): String =
            stringResource(R.string.override_form_dns_upstream_servers, *args)
        ...
        fun `NameserverPolicySection`(vararg args: Any): String =
            stringResource(R.string.override_form_nameserver_policy_section, *args)
        ...
        fun `FilterList`(vararg args: Any): String =
            stringResource(R.string.override_form_filter_list, *args)
        ...
        fun `FallbackSwitch`(vararg args: Any): String =
            stringResource(R.string.override_form_fallback_switch, *args)
        ...
        fun `FallbackParams`(vararg args: Any): String =
            stringResource(R.string.override_form_fallback_params, *args)
        ...
        fun `FallbackFilter`(vararg args: Any): String =
            stringResource(R.string.override_form_fallback_filter, *args)
        ...
        fun `BasicPolicy`(vararg args: Any): String =
            stringResource(R.string.override_form_basic_policy, *args)
        ...
        fun `SkipAndForce`(vararg args: Any): String =
            stringResource(R.string.override_form_skip_and_force, *args)
        ...
        fun `SkipSrcAddress`(vararg args: Any): String =
            stringResource(R.string.override_form_skip_src_address, *args)
        ...
        fun `SkipDstAddress`(vararg args: Any): String =
            stringResource(R.string.override_form_skip_dst_address, *args)
    }
    ...
    object `Rule` {
        ...
        fun `EmptyWarning`(vararg args: Any): String =
            stringResource(R.string.override_rule_empty_warning, *args)
        ...
        fun `InvalidFormatWarning`(vararg args: Any): String =
            stringResource(R.string.override_rule_invalid_format_warning, *args)
        ...
        fun `MissingTargetWarning`(vararg args: Any): String =
            stringResource(R.string.override_rule_missing_target_warning, *args)
    }
    ...
    object `Save` {
        ...
        fun `PresetNotModifiable`(vararg args: Any): String =
            stringResource(R.string.override_save_preset_not_modifiable, *args)
        ...
        fun `ApplyFailed`(vararg args: Any): String =
            stringResource(R.string.override_save_apply_failed, *args)
        ...
        @Composable
        fun `Failed`(vararg args: Any): String =
            stringResource(R.string.override_save_failed, *args)
        ...
        fun `RuntimeSaveFailed`(vararg args: Any): String =
            stringResource(R.string.override_save_runtime_save_failed, *args)
        ...
        fun `RuntimeOverrideName`(vararg args: Any): String =
            stringResource(R.string.override_save_runtime_override_name, *args)
        ...
        fun `ImportEmpty`(vararg args: Any): String =
            stringResource(R.string.override_save_import_empty, *args)
        ...
        fun `ImportDefaultName`(vararg args: Any): String =
            stringResource(R.string.override_save_import_default_name, *args)
    }
    ...
    object `Dns` {
        ...
        @Composable
        fun `Policy`(vararg args: Any): String = stringResource(R.string.override_dns_policy, *args)
        ...
        fun `PolicyNotModify`(vararg args: Any): String =
            stringResource(R.string.override_dns_policy_not_modify, *args)
        ...
        fun `PolicyForceEnable`(vararg args: Any): String =
            stringResource(R.string.override_dns_policy_force_enable, *args)
        ...
        fun `PolicyUseBuiltin`(vararg args: Any): String =
            stringResource(R.string.override_dns_policy_use_builtin, *args)
        ...
        fun `PreferH3`(vararg args: Any): String =
            stringResource(R.string.override_dns_prefer_h3, *args)

        val `Listen`: String
            get() = LocaleBootstrap.getString(R.string.override_dns_listen)

        @Composable
        fun `Listen`(vararg args: Any): String = stringResource(R.string.override_dns_listen, *args)
        ...
        fun `ListenHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_listen_hint, *args)

        val `Ipv6`: String
            get() = LocaleBootstrap.getString(R.string.override_dns_ipv6)

        @Composable
        fun `Ipv6`(vararg args: Any): String = stringResource(R.string.override_dns_ipv6, *args)
        ...
        fun `UseHosts`(vararg args: Any): String =
            stringResource(R.string.override_dns_use_hosts, *args)
        ...
        fun `AppendSystem`(vararg args: Any): String =
            stringResource(R.string.override_dns_append_system, *args)
        ...
        fun `EnhancedMode`(vararg args: Any): String =
            stringResource(R.string.override_dns_enhanced_mode, *args)
        ...
        fun `EnhancedNotModify`(vararg args: Any): String =
            stringResource(R.string.override_dns_enhanced_not_modify, *args)
        ...
        fun `EnhancedDisable`(vararg args: Any): String =
            stringResource(R.string.override_dns_enhanced_disable, *args)
        ...
        fun `EnhancedFakeip`(vararg args: Any): String =
            stringResource(R.string.override_dns_enhanced_fakeip, *args)
        ...
        fun `EnhancedMapping`(vararg args: Any): String =
            stringResource(R.string.override_dns_enhanced_mapping, *args)
        ...
        fun `DirectFollowPolicy`(vararg args: Any): String =
            stringResource(R.string.override_dns_direct_follow_policy, *args)
        ...
        fun `Ipv6Timeout`(vararg args: Any): String =
            stringResource(R.string.override_dns_ipv6_timeout, *args)
        ...
        fun `Servers`(vararg args: Any): String =
            stringResource(R.string.override_dns_servers, *args)
        ...
        fun `ServersHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_servers_hint, *args)
        ...
        fun `Fallback`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback, *args)
        ...
        fun `FallbackHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_hint, *args)
        ...
        fun `Default`(vararg args: Any): String =
            stringResource(R.string.override_dns_default, *args)
        ...
        fun `DefaultHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_default_hint, *args)
        ...
        fun `FakeipFilter`(vararg args: Any): String =
            stringResource(R.string.override_dns_fakeip_filter, *args)
        ...
        fun `FakeipFilterHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_fakeip_filter_hint, *args)
        ...
        fun `FakeipFilterMode`(vararg args: Any): String =
            stringResource(R.string.override_dns_fakeip_filter_mode, *args)
        ...
        fun `FakeipBlacklist`(vararg args: Any): String =
            stringResource(R.string.override_dns_fakeip_blacklist, *args)
        ...
        fun `FakeipWhitelist`(vararg args: Any): String =
            stringResource(R.string.override_dns_fakeip_whitelist, *args)
        ...
        fun `FallbackGeoip`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_geoip, *args)
        ...
        fun `FallbackGeoipCode`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_geoip_code, *args)
        ...
        fun `FallbackGeoipCodeHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_geoip_code_hint, *args)
        ...
        fun `FallbackDomain`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_domain, *args)
        ...
        fun `FallbackDomainHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_domain_hint, *args)
        ...
        fun `FallbackIpcidr`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_ipcidr, *args)
        ...
        fun `FallbackIpcidrHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_ipcidr_hint, *args)
        ...
        fun `FallbackGeosite`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_geosite, *args)
        ...
        fun `FallbackGeositeHint`(vararg args: Any): String =
            stringResource(R.string.override_dns_fallback_geosite_hint, *args)
        ...
        fun `NameserverPolicy`(vararg args: Any): String =
            stringResource(R.string.override_dns_nameserver_policy, *args)
        ...
        fun `NameserverPolicyKey`(vararg args: Any): String =
            stringResource(R.string.override_dns_nameserver_policy_key, *args)
        ...
        fun `NameserverPolicyValue`(vararg args: Any): String =
            stringResource(R.string.override_dns_nameserver_policy_value, *args)
        ...
        fun `FakeipRange6`(vararg args: Any): String =
            stringResource(R.string.override_dns_fakeip_range6, *args)
        ...
        fun `FakeipTtl`(vararg args: Any): String =
            stringResource(R.string.override_dns_fakeip_ttl, *args)
        ...
        fun `ProxyServerNameserver`(vararg args: Any): String =
            stringResource(R.string.override_dns_proxy_server_nameserver, *args)
        ...
        fun `DirectNameserver`(vararg args: Any): String =
            stringResource(R.string.override_dns_direct_nameserver, *args)
        ...
        fun `ProxyServerNameserverPolicy`(vararg args: Any): String =
            stringResource(R.string.override_dns_proxy_server_nameserver_policy, *args)
        ...
        fun `ProxyServerNameserverPolicyKey`(vararg args: Any): String =
            stringResource(R.string.override_dns_proxy_server_nameserver_policy_key, *args)
        ...
        fun `ProxyServerNameserverPolicyValue`(vararg args: Any): String =
            stringResource(R.string.override_dns_proxy_server_nameserver_policy_value, *args)

        val `Hosts`: String
            get() = LocaleBootstrap.getString(R.string.override_dns_hosts)

        @Composable
        fun `Hosts`(vararg args: Any): String = stringResource(R.string.override_dns_hosts, *args)
        ...
        fun `HostsKey`(vararg args: Any): String =
            stringResource(R.string.override_dns_hosts_key, *args)
        ...
        fun `HostsValue`(vararg args: Any): String =
            stringResource(R.string.override_dns_hosts_value, *args)
    }
    ...
    object `General` {
        ...
        fun `HttpPort`(vararg args: Any): String =
            stringResource(R.string.override_general_http_port, *args)
        ...
        fun `TlsPort`(vararg args: Any): String =
            stringResource(R.string.override_general_tls_port, *args)
        ...
        fun `QuicPort`(vararg args: Any): String =
            stringResource(R.string.override_general_quic_port, *args)
        ...
        fun `SocksPort`(vararg args: Any): String =
            stringResource(R.string.override_general_socks_port, *args)
        ...
        fun `MixedPort`(vararg args: Any): String =
            stringResource(R.string.override_general_mixed_port, *args)
        ...
        fun `RedirectPort`(vararg args: Any): String =
            stringResource(R.string.override_general_redirect_port, *args)
        ...
        fun `TproxyPort`(vararg args: Any): String =
            stringResource(R.string.override_general_tproxy_port, *args)
        ...
        fun `AllowLan`(vararg args: Any): String =
            stringResource(R.string.override_general_allow_lan, *args)

        val `Ipv6`: String
            get() = LocaleBootstrap.getString(R.string.override_general_ipv6)

        @Composable
        fun `Ipv6`(vararg args: Any): String = stringResource(R.string.override_general_ipv6, *args)
        ...
        fun `ProxyMode`(vararg args: Any): String =
            stringResource(R.string.override_general_proxy_mode, *args)
        ...
        fun `LogLevel`(vararg args: Any): String =
            stringResource(R.string.override_general_log_level, *args)
    }
    ...
    object `Label` {
        ...
        fun `CacheAlgorithm`(vararg args: Any): String =
            stringResource(R.string.override_label_cache_algorithm, *args)
        ...
        fun `Enable`(vararg args: Any): String =
            stringResource(R.string.override_label_enable, *args)
        ...
        fun `FakeIpRange`(vararg args: Any): String =
            stringResource(R.string.override_label_fake_ip_range, *args)
        ...
        fun `ForceDnsMapping`(vararg args: Any): String =
            stringResource(R.string.override_label_force_dns_mapping, *args)
        ...
        fun `ForceDomain`(vararg args: Any): String =
            stringResource(R.string.override_label_force_domain, *args)
        ...
        fun `HttpOverride`(vararg args: Any): String =
            stringResource(R.string.override_label_http_override, *args)
        ...
        fun `KeepAliveIdle`(vararg args: Any): String =
            stringResource(R.string.override_label_keep_alive_idle, *args)
        ...
        fun `KeepAliveInterval`(vararg args: Any): String =
            stringResource(R.string.override_label_keep_alive_interval, *args)
        ...
        fun `OverrideDestination`(vararg args: Any): String =
            stringResource(R.string.override_label_override_destination, *args)
        ...
        fun `ParsePureIp`(vararg args: Any): String =
            stringResource(R.string.override_label_parse_pure_ip, *args)
        ...
        fun `QuicOverride`(vararg args: Any): String =
            stringResource(R.string.override_label_quic_override, *args)
        ...
        fun `RespectRules`(vararg args: Any): String =
            stringResource(R.string.override_label_respect_rules, *args)
        ...
        fun `RulesReplace`(vararg args: Any): String =
            stringResource(R.string.override_label_rules_replace, *args)
        ...
        fun `SkipDomain`(vararg args: Any): String =
            stringResource(R.string.override_label_skip_domain, *args)
        ...
        fun `TlsOverride`(vararg args: Any): String =
            stringResource(R.string.override_label_tls_override, *args)
        ...
        fun `UseSystemHosts`(vararg args: Any): String =
            stringResource(R.string.override_label_use_system_hosts, *args)
    }
}
