...
object MLangSettings {
    ...
    fun `Title`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.settings_title, *args)
    ...
    object `Section` {
        ...
        fun `UiSettings`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_section_ui_settings, *args)
        ...
        fun `More`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_section_more, *args)
        ...
        fun `Advanced`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_section_advanced, *args)
    }
    ...
    object `UiSettings` {
        ...
        fun `App`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_ui_settings_app, *args)
        ...
        fun `AppSummary`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_ui_settings_app_summary, *args)
        ...
        fun `Network`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_ui_settings_network, *args)
        ...
        fun `NetworkSummary`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_ui_settings_network_summary, *args)
        ...
        fun `Override`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_ui_settings_override, *args)
        ...
        fun `OverrideSummary`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_ui_settings_override_summary, *args)
        ...
        fun `MetaFeatures`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_ui_settings_meta_features, *args)
        ...
        fun `MetaFeaturesSummary`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_ui_settings_meta_features_summary, *args)
    }
    ...
    object `More` {
        ...
        fun `TrafficStatistics`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_more_traffic_statistics, *args)
        ...
        fun `TrafficStatisticsSummary`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_more_traffic_statistics_summary, *args)

        val `Logs`: String
            get() = LocaleBootstrap.getString(R.string.settings_more_logs)

        @Composable
        fun `Logs`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_more_logs, *args)
        ...
        fun `LogsSummary`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_more_logs_summary, *args)

        val `About`: String
            get() = LocaleBootstrap.getString(R.string.settings_more_about)

        @Composable
        fun `About`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.settings_more_about, *args)
