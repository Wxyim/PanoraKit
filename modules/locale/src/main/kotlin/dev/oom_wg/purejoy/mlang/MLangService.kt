...
object MLangService {
    object `Notification` {
        ...
        fun `Running`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_notification_running, *args)
        ...
        fun `TrafficFormat`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_notification_traffic_format, *args)
        ...
        fun `UnknownProfile`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_notification_unknown_profile, *args)
    }
    ...
    object `Tile` {
        ...
        fun `ClickToOpen`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_tile_click_to_open, *args)
        ...
        fun `ClickToStartProxy`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_tile_click_to_start_proxy, *args)
        ...
        fun `ClickToStopProxy`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_tile_click_to_stop_proxy, *args)
        ...
        fun `Connecting`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_tile_connecting, *args)
    ...
    object `LogRecord` {
        ...
        @Composable
        fun `ChannelName`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_log_record_channel_name, *args)
        ...
        @Composable
        fun `ChannelDescription`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_log_record_channel_description, *args)
        ...
        fun `NotificationTitle`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_log_record_notification_title, *args)
        ...
        fun `NotificationContent`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_log_record_notification_content, *args)
        ...
        fun `ActionStop`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.service_log_record_action_stop, *args)
    }
}
