...
object MLangMetaFeature {
    ...
    @Composable
    fun `Title`(vararg args: Any): String = stringResource(R.string.meta_feature_title, *args)
    ...
    object `RecentRequests` {
        ...
        fun `Title`(vararg args: Any): String =
            stringResource(R.string.meta_feature_recent_requests_title, *args)
        ...
        fun `Summary`(vararg args: Any): String =
            stringResource(R.string.meta_feature_recent_requests_summary, *args)
    }
    ...
    object `RuntimeConfig` {
        ...
        @Composable
        fun `Title`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_title, *args)
        ...
        @Composable
        fun `Summary`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_summary, *args)
        ...
        fun `LoadFailed`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_load_failed, *args)
        ...
        fun `NoActiveProfile`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_no_active_profile, *args)
        ...
        fun `ConfigNotFound`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_config_not_found, *args)
        ...
        fun `PreviewTitle`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_preview_title, *args)
        ...
        fun `PreviewTitleWithProfile`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_preview_title_with_profile, *args)
        ...
        fun `RuntimeConfigFetchFailed`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_runtime_config_fetch_failed, *args)
        ...
        fun `RuntimeConfigUnauthorized`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_runtime_config_unauthorized, *args)
        ...
        fun `RuntimeConfigNotRunning`(vararg args: Any): String =
            stringResource(R.string.meta_feature_runtime_config_runtime_config_not_running, *args)
    }
    ...
    object `GeoX` {
        ...
        fun `OnlineUpdateTitle`(vararg args: Any): String =
            stringResource(R.string.meta_feature_geo_x_online_update_title, *args)
        ...
        fun `OnlineUpdateSummary`(vararg args: Any): String =
            stringResource(R.string.meta_feature_geo_x_online_update_summary, *args)
    }
    ...
    object `Download` {
        ...
        fun `DialogTitle`(vararg args: Any): String =
            stringResource(R.string.meta_feature_download_dialog_title, *args)
        ...
        fun `SelectFiles`(vararg args: Any): String =
            stringResource(R.string.meta_feature_download_select_files, *args)
        ...
        fun `DownloadComplete`(vararg args: Any): String =
            stringResource(R.string.meta_feature_download_download_complete, *args)
    }
    ...
    object `Dashboard` {
        ...
        @Composable
        fun `Title`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_title, *args)
        ...
        fun `Port`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_port, *args)
        ...
        fun `PortSummary`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_port_summary, *args)
        ...
        fun `Secret`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_secret, *args)
        ...
        fun `SecretSummary`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_secret_summary, *args)
        ...
        fun `ShowSecret`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_show_secret, *args)
        ...
        fun `Download`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_download, *args)
        ...
        fun `DownloadSummary`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_download_summary, *args)
        ...
        fun `DownloadOk`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_download_ok, *args)
        ...
        fun `DownloadFailed`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_download_failed, *args)
        ...
        fun `Launch`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_launch, *args)
        ...
        fun `LaunchSummary`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_launch_summary, *args)
        ...
        fun `LaunchDisabled`(vararg args: Any): String =
            stringResource(R.string.meta_feature_dashboard_launch_disabled, *args)
    }
}
