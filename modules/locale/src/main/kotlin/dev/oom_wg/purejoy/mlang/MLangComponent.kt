...
object MLangComponent {
    object `ProfileCard` {
        ...
        fun `Export`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_export, *args)
        ...
        fun `Edit`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_edit, *args)
        ...
        fun `Update`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_update, *args)
        ...
        fun `Delete`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_delete, *args)
        ...
        fun `RemoteSubscription`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_remote_subscription, *args)
        ...
        fun `LocalFile`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_local_file, *args)
        ...
        fun `LocalConfig`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_local_config, *args)
        ...
        fun `ClickToUpdate`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_click_to_update, *args)
        ...
        fun `Traffic`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_traffic, *args)
        ...
        fun `UsedTraffic`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_used_traffic, *args)
        ...
        fun `ExpireAt`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_expire_at, *args)
        ...
        fun `ExpireToday`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_expire_today, *args)
        ...
        fun `Expired`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_expired, *args)
        ...
        fun `JustNow`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_just_now, *args)
        ...
        fun `MinutesAgo`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_minutes_ago, *args)
        ...
        fun `HoursAgo`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_hours_ago, *args)
        ...
        fun `DaysAgo`(vararg args: Any): String =
            stringResource(R.string.component_profile_card_days_ago, *args)
    }
    ...
    object `WebView` {
        ...
        fun `InvalidUrl`(vararg args: Any): String =
            stringResource(R.string.component_web_view_invalid_url, *args)
    }
    ...
    object `Selector` {
        ...
        fun `NotModify`(vararg args: Any): String =
            stringResource(R.string.component_selector_not_modify, *args)
        ...
        fun `UseDefault`(vararg args: Any): String =
            stringResource(R.string.component_selector_use_default, *args)
        ...
        fun `Enable`(vararg args: Any): String =
            stringResource(R.string.component_selector_enable, *args)
        ...
        fun `Disable`(vararg args: Any): String =
            stringResource(R.string.component_selector_disable, *args)
        ...
        fun `Replace`(vararg args: Any): String =
            stringResource(R.string.component_selector_replace, *args)
        ...
        fun `Prepend`(vararg args: Any): String =
            stringResource(R.string.component_selector_prepend, *args)
        ...
        fun `Append`(vararg args: Any): String =
            stringResource(R.string.component_selector_append, *args)
        ...
        fun `Merge`(vararg args: Any): String =
            stringResource(R.string.component_selector_merge, *args)
    }
    ...
    object `Navigation` {
        ...
        fun `Back`(vararg args: Any): String =
            stringResource(R.string.component_navigation_back, *args)
        ...
        fun `Refresh`(vararg args: Any): String =
            stringResource(R.string.component_navigation_refresh, *args)
        ...
        fun `Search`(vararg args: Any): String =
            stringResource(R.string.component_navigation_search, *args)
        ...
        fun `Sort`(vararg args: Any): String =
            stringResource(R.string.component_navigation_sort, *args)
        ...
        fun `Settings`(vararg args: Any): String =
            stringResource(R.string.component_navigation_settings, *args)
    }
    ...
    object `Message` {
        ...
        fun `Confirm`(vararg args: Any): String =
            stringResource(R.string.component_message_confirm, *args)
        ...
        fun `Hint`(vararg args: Any): String =
            stringResource(R.string.component_message_hint, *args)
        ...
        fun `Error`(vararg args: Any): String =
            stringResource(R.string.component_message_error, *args)
        ...
        fun `Success`(vararg args: Any): String =
            stringResource(R.string.component_message_success, *args)
    }
    ...
    object `Button` {
        ...
        fun `Cancel`(vararg args: Any): String =
            stringResource(R.string.component_button_cancel, *args)
        ...
        @Composable
        fun `Confirm`(vararg args: Any): String =
            stringResource(R.string.component_button_confirm, *args)
        ...
        fun `Clear`(vararg args: Any): String =
            stringResource(R.string.component_button_clear, *args)

        val `Edit`: String
            get() = LocaleBootstrap.getString(R.string.component_button_edit)

        @Composable
        fun `Edit`(vararg args: Any): String = stringResource(R.string.component_button_edit, *args)
        ...
        fun `Start`(vararg args: Any): String =
            stringResource(R.string.component_button_start, *args)
    }
    ...
    object `Loading` {
        ...
        fun `Starting`(vararg args: Any): String =
            stringResource(R.string.component_loading_starting, *args)
    }
    ...
    object `Update` {
        object `Title` {
            ...
            fun `Available`(vararg args: Any): String =
                stringResource(R.string.component_update_title_available, *args)
            ...
            fun `ForceCancel`(vararg args: Any): String =
                stringResource(R.string.component_update_title_force_cancel, *args)
            ...
            fun `Install`(vararg args: Any): String =
                stringResource(R.string.component_update_title_install, *args)
        }
        ...
        object `Message` {
            ...
            @Composable
            fun `Available`(vararg args: Any): String =
                stringResource(R.string.component_update_message_available, *args)
            ...
            fun `CoverDesc`(vararg args: Any): String =
                stringResource(R.string.component_update_message_cover_desc, *args)
            ...
            fun `CurrentVersion`(vararg args: Any): String =
                stringResource(R.string.component_update_message_current_version, *args)
            ...
            fun `RemoteVersion`(vararg args: Any): String =
                stringResource(R.string.component_update_message_remote_version, *args)
            ...
            fun `Updating`(vararg args: Any): String =
                stringResource(R.string.component_update_message_updating, *args)
            ...
            fun `Preparing`(vararg args: Any): String =
                stringResource(R.string.component_update_message_preparing, *args)
            ...
            fun `DownloadingWithProgress`(vararg args: Any): String =
                stringResource(R.string.component_update_message_downloading_with_progress, *args)
            ...
            fun `Verifying`(vararg args: Any): String =
                stringResource(R.string.component_update_message_verifying, *args)
            ...
            fun `Finished`(vararg args: Any): String =
                stringResource(R.string.component_update_message_finished, *args)
            ...
            fun `Downloading`(vararg args: Any): String =
                stringResource(R.string.component_update_message_downloading, *args)
            ...
            fun `DownloadReady`(vararg args: Any): String =
                stringResource(R.string.component_update_message_download_ready, *args)
            ...
            fun `VerifyFailed`(vararg args: Any): String =
                stringResource(R.string.component_update_message_verify_failed, *args)
            ...
            fun `DownloadErrorWithCode`(vararg args: Any): String =
                stringResource(R.string.component_update_message_download_error_with_code, *args)
            ...
            @Composable
            fun `Error`(vararg args: Any): String =
                stringResource(R.string.component_update_message_error, *args)
            ...
            fun `Close`(vararg args: Any): String =
                stringResource(R.string.component_update_message_close, *args)
            ...
            fun `Waiting`(vararg args: Any): String =
                stringResource(R.string.component_update_message_waiting, *args)
        }
    }
    ...
    object `ConfigInput` {
        ...
        fun `PortLabel`(vararg args: Any): String =
            stringResource(R.string.component_config_input_port_label, *args)
        ...
        fun `CountItems`(vararg args: Any): String =
            stringResource(R.string.component_config_input_count_items, *args)
        ...
        fun `ReplaceHelper`(vararg args: Any): String =
            stringResource(R.string.component_config_input_replace_helper, *args)
        ...
        fun `MergeHelper`(vararg args: Any): String =
            stringResource(R.string.component_config_input_merge_helper, *args)
        ...
        fun `MergeNotice`(vararg args: Any): String =
            stringResource(R.string.component_config_input_merge_notice, *args)
    }
    ...
    object `Accessibility` {
        ...
        fun `CountryFlag`(vararg args: Any): String =
            stringResource(R.string.component_accessibility_country_flag, *args)
    }
    ...
    object `BottomBar` {
        ...
        fun `Home`(vararg args: Any): String =
            stringResource(R.string.component_bottom_bar_home, *args)
        ...
        fun `Proxy`(vararg args: Any): String =
            stringResource(R.string.component_bottom_bar_proxy, *args)
        ...
        fun `Config`(vararg args: Any): String =
            stringResource(R.string.component_bottom_bar_config, *args)
        ...
        fun `Setting`(vararg args: Any): String =
            stringResource(R.string.component_bottom_bar_setting, *args)
    }
    ...
    object `Editor` {
        ...
        @Composable
        fun `CountItems`(vararg args: Any): String =
            stringResource(R.string.component_editor_count_items, *args)
        ...
        object `Action` {
            ...
            fun `Reset`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_reset, *args)
            ...
            fun `Add`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_add, *args)
            ...
            @Composable
            fun `Delete`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_delete, *args)
            ...
            fun `Undo`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_undo, *args)
            ...
            fun `Redo`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_redo, *args)
            ...
            fun `Format`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_format, *args)
            ...
            fun `Save`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_save, *args)
            ...
            fun `SaveAndExit`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_save_and_exit, *args)
            ...
            fun `SaveLocally`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_save_locally, *args)
            ...
            fun `SaveAndStop`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_save_and_stop, *args)
            ...
            fun `ContinueEditing`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_continue_editing, *args)
            ...
            fun `Discard`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_discard, *args)
            ...
            fun `Check`(vararg args: Any): String =
                stringResource(R.string.component_editor_action_check, *args)
        }
        ...
        object `Dialog` {
            ...
            fun `AddTitle`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_add_title, *args)
            ...
            fun `EditTitle`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_edit_title, *args)
            ...
            fun `ResetTitle`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_reset_title, *args)
            ...
            fun `ResetMessage`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_reset_message, *args)
            ...
            fun `DiscardTitle`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_discard_title, *args)
            ...
            fun `DiscardMessage`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_discard_message, *args)
            ...
            fun `JsonSubtitle`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_json_subtitle, *args)
            ...
            fun `ConfigPreviewTitle`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_config_preview_title, *args)
            ...
            fun `LocalSaving`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_local_saving, *args)
            ...
            fun `ValidatingConfig`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_validating_config, *args)
            ...
            fun `ValidationPassed`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_validation_passed, *args)
            ...
            fun `FetchingRemoteResources`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_fetching_remote_resources, *args)
            ...
            fun `ApplyingRuntime`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_applying_runtime, *args)
            ...
            fun `LongRunningUndoSummary`(vararg args: Any): String =
                stringResource(R.string.component_editor_dialog_long_running_undo_summary, *args)
        ...
        object `Empty` {
            ...
            fun `Title`(vararg args: Any): String =
                stringResource(R.string.component_editor_empty_title, *args)
            ...
            @Composable
            fun `Hint`(vararg args: Any): String =
                stringResource(R.string.component_editor_empty_hint, *args)
        }
        ...
        object `Error` {
            ...
            fun `KeyEmpty`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_key_empty, *args)
            ...
            fun `KeyExists`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_key_exists, *args)
            ...
            fun `SaveFailed`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_save_failed, *args)
            ...
            fun `JsonSyntaxError`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_json_syntax_error, *args)
            ...
            fun `ValidationFailed`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_validation_failed, *args)
            ...
            fun `JsonRootExpected`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_json_root_expected, *args)
            ...
            fun `YamlSyntaxError`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_yaml_syntax_error, *args)
            ...
            fun `Unterminated`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_unterminated, *args)
            ...
            fun `Expected`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_expected, *args)
            ...
            fun `Unknown`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_unknown, *args)
            ...
            fun `MissingValue`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_missing_value, *args)
            ...
            fun `DuplicateKey`(vararg args: Any): String =
                stringResource(R.string.component_editor_error_duplicate_key, *args)
        }
        ...
        object `Rule` {
            ...
            fun `Type`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_type, *args)
            ...
            fun `Target`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_target, *args)
            ...
            fun `Content`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_content, *args)
            ...
            fun `Src`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_src, *args)
            ...
            fun `NoResolve`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_no_resolve, *args)
            ...
            fun `TargetReject`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_target_reject, *args)
            ...
            fun `TargetDirect`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_target_direct, *args)
            ...
            fun `TargetMatch`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_target_match, *args)
            ...
            fun `ErrorTargetRequired`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_error_target_required, *args)
            ...
            fun `ErrorContentRequired`(vararg args: Any): String =
                stringResource(R.string.component_editor_rule_error_content_required, *args)
        }
    }
}
