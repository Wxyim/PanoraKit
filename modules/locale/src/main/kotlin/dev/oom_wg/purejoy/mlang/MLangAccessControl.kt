...
object MLangAccessControl {
    ...
    fun `Title`(vararg args: Any): String =
        LocaleBootstrap.getString(R.string.access_control_title, *args)
    ...
    object `Search` {
        ...
        fun `Placeholder`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_search_placeholder, *args)
        ...
        fun `EmptyResults`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_search_empty_results, *args)
    }
    ...
    object `AppList` {
        ...
        fun `Loading`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_app_list_loading, *args)
        ...
        fun `OpenPermissionSettings`(vararg args: Any): String =
            LocaleBootstrap.getString(
                R.string.access_control_app_list_open_permission_settings,
                *args,
            )
        ...
        fun `ManualAddTitle`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_app_list_manual_add_title, *args)
        ...
        fun `ManualAddPlaceholder`(vararg args: Any): String =
            LocaleBootstrap.getString(
                R.string.access_control_app_list_manual_add_placeholder,
                *args,
            )
        ...
        fun `AddPackage`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_app_list_add_package, *args)
        ...
        fun `InvalidPackage`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_app_list_invalid_package, *args)
        ...
        fun `SelectedPackagesTitle`(vararg args: Any): String =
            LocaleBootstrap.getString(
                R.string.access_control_app_list_selected_packages_title,
                *args,
            )
        ...
        fun `NoSelectedPackages`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_app_list_no_selected_packages, *args)
    }
    ...
    object `Settings` {
        ...
        @Composable
        fun `Title`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_title, *args)
        ...
        fun `SelectedFirst`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_selected_first, *args)
        ...
        fun `BatchOperation`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_batch_operation, *args)
        ...
        fun `SelectAll`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_select_all, *args)
        ...
        fun `DeselectAll`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_deselect_all, *args)
        ...
        fun `Invert`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_invert, *args)
        ...
        fun `CopySelected`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_copy_selected, *args)
        ...
        fun `ClearSelected`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_clear_selected, *args)
        ...
        fun `ClearSelectedResult`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_clear_selected_result, *args)
        ...
        fun `ImportExport`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_import_export, *args)
        ...
        fun `Import`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_import, *args)
        ...
        fun `Export`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_export, *args)
        ...
        fun `ImportSuccess`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_import_success, *args)
        ...
        fun `ImportPartial`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_import_partial, *args)
        ...
        fun `ExportSuccess`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_export_success, *args)
        ...
        fun `ImportFailed`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_import_failed, *args)
        ...
        fun `RegionQuickSelect`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_region_quick_select, *args)
        ...
        fun `ChinaApps`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_china_apps, *args)
        ...
        fun `OverseasApps`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_overseas_apps, *args)
        ...
        fun `RegionSelectResult`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_settings_region_select_result, *args)
    }
    ...
    object `SortMode` {
        ...
        fun `PackageName`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_sort_mode_package_name, *args)
        ...
        fun `Label`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_sort_mode_label, *args)
        ...
        fun `InstallTime`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_sort_mode_install_time, *args)
        ...
        fun `UpdateTime`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_sort_mode_update_time, *args)
    }
    ...
    object `Button` {
        ...
        fun `Cancel`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_button_cancel, *args)
        ...
        fun `Confirm`(vararg args: Any): String =
            LocaleBootstrap.getString(R.string.access_control_button_confirm, *args)
    }
}
