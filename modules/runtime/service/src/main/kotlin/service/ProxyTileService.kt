...
import com.github.nomadboxlab.monadbox.data.store.MMKVProvider
            ...
            scope.launch {
                ...
                try {
                    if (isRunning) {
                        ...
                        val activeProfile =
                            withContext(Dispatchers.IO) { profileManager.queryActive() }
                        ...
                        when (currentMode) {
                            ProxyMode.Tun -> {
                                ...
                                if (vpnIntent != null) {
                                    updateTileInactiveState(
                                        subtitle = MLang.Service.Tile.ClickToOpen
                                    )
