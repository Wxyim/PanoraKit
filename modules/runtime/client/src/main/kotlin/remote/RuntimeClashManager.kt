...
class RuntimeClashManager(context: Context, private val local: IClashManager) :
    ...
    override fun queryTunnelState(): TunnelState {
        return queryWithRuntime(
            rootCall = { rootCallBlocking { RootTunController.queryTunnelState(appContext) } },
    ...
    override fun queryTrafficNow(): Long {
        return queryWithRuntime(
            rootCall = { rootCallBlocking { RootTunController.queryTrafficNow(appContext) } },
    ...
    override fun queryTrafficTotal(): Long {
        return queryWithRuntime(
            rootCall = { rootCallBlocking { RootTunController.queryTrafficTotal(appContext) } },
    ...
    override fun queryRuntimeDataSnapshot(): RuntimeDataSnapshot {
        return queryWithRuntime(
            rootCall = {
                rootCallBlocking { RootTunController.queryRuntimeDataSnapshot(appContext) }
            },
            localCall = { local.queryRuntimeDataSnapshot() },
            fallbackOnRootFailure = false,
        )
    }
    ...
    override fun queryConfiguration(): UiConfiguration {
        return queryWithRuntime(
            rootCall = { rootCallBlocking { RootTunController.queryConfiguration(appContext) } },
    ...
    override fun closeAllConnections() {
        queryWithRuntime(
            rootCall = { rootCallBlocking { RootTunController.closeAllConnections(appContext) } },
    ...
    override fun requestStop() {
        queryWithRuntime(
            rootCall = { rootCallBlocking { RootTunController.requestStop(appContext) } },
    ...
    private inline fun <T> queryWithRuntime(
        ...
        return try {
            ...
            val mapped = mapRootRuntimeFailure(error)
            handleRootRuntimeFailure(error)
            if (fallbackOnRootFailure) localCall() else throw mapped
        }
    }
