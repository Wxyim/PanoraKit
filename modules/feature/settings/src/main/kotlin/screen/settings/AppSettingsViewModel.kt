...
class AppSettingsViewModel(
    ...
    private val cleanupController: CleanupController,
) : ViewModel() {
    ...
    fun onCleanupAutoEnabledChange(enabled: Boolean) {
        ...
        cleanupController.syncSchedule(enabled)
    }

    fun onCleanupPolicyChange(policy: CleanupPolicy) {
        cleanupPolicy.set(policy)
        cleanupController.syncSchedule(cleanupAutoEnabled.value)
    }
    ...
    suspend fun runCleanupNow(): CleanupController.CleanupResult {
        return cleanupController.runCleanupNow()
    }
