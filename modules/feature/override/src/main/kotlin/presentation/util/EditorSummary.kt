...
import com.github.nomadboxlab.monadbox.presentation.viewmodel.RuleValidator
...
object OverrideEditorSummaryBuilder {
            ...
            visualModes =
                buildSet {
                    ...
                    addListModes(
                        ...
                        config.authenticationStart,
                        config.authenticationEnd,
                    )
                    addListModes(
                    ...
                    addListModes(
                        config.lanAllowedIps,
                        config.lanAllowedIpsStart,
                        config.lanAllowedIpsEnd,
                    )
                    addListModes(
        ...
        return OverrideSectionSummary(
            modifiedCount =
                countPresent(
                    ...
                    countListGroup(
                        config.tun.dnsHijack,
                        config.tun.dnsHijackStart,
                        config.tun.dnsHijackEnd,
                    ) +
                    countListGroup(
        ...
        return OverrideSectionSummary(
            modifiedCount =
                countPresent(
                    ...
                    countListGroup(
                        config.dns.fallback,
                        config.dns.fallbackStart,
                        config.dns.fallbackEnd,
                    ) +
                    countListGroup(
    ...
    private fun buildRulesSummary(config: ConfigurationOverride): OverrideSectionSummary {
        return OverrideSectionSummary(
            ...
            visualModes =
                buildSet { addListModes(config.rules, config.rulesStart, config.rulesEnd) },
        )
    }
    ...
    private fun buildProxiesSummary(config: ConfigurationOverride): OverrideSectionSummary {
        return OverrideSectionSummary(
            ...
            visualModes =
                buildSet { addListModes(config.proxies, config.proxiesStart, config.proxiesEnd) },
        )
    }
    ...
    private fun buildProxyProvidersSummary(config: ConfigurationOverride): OverrideSectionSummary {
        return OverrideSectionSummary(
            ...
            visualModes =
                buildSet { addMapModes(config.proxyProviders, config.proxyProvidersMerge) },
        )
    }
    ...
    private fun buildProxyGroupsSummary(config: ConfigurationOverride): OverrideSectionSummary {
        return OverrideSectionSummary(
            modifiedCount =
                countListGroup(config.proxyGroups, config.proxyGroupsStart, config.proxyGroupsEnd),
            visualModes =
                buildSet {
    ...
    private fun buildRuleProvidersSummary(config: ConfigurationOverride): OverrideSectionSummary {
        return OverrideSectionSummary(
            ...
            visualModes = buildSet { addMapModes(config.ruleProviders, config.ruleProvidersMerge) },
        )
    }
    ...
    private fun buildSubRulesSummary(config: ConfigurationOverride): OverrideSectionSummary {
        return OverrideSectionSummary(
            ...
            visualModes = buildSet { addMapModes(config.subRules, config.subRulesMerge) },
        )
    }
    ...
    private fun countListGroup(replaceValue: Any?, startValue: Any?, endValue: Any?): Int {
        return if (isConfigured(replaceValue) || isConfigured(startValue) || isConfigured(endValue))
            1
        else 0
    }

    private fun countMapGroup(replaceValue: Any?, mergeValue: Any?): Int {
